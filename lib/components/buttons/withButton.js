...
WithButton=(_temp=_class=function(_Component){_inherits(WithButton,_Component);
function WithButton(props){_classCallCheck(this,WithButton);var _this=_possibleConstructorReturn(this,(WithButton.__proto__||Object.getPrototypeOf(WithButton)).call(this,
props));
_this.state={
butonState:'normal'};return _this;

}_createClass(WithButton,[{key:'getThemeStyle',value:function getThemeStyle()
